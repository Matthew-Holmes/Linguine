...
namespace Linguine.Tabs
{
    internal class TextualMediaViewerViewModel : TabViewModelBase
    {
        ...
        */
        public TextualMediaViewerViewModel(TextualMediaSession session, UIComponents uiComponents, MainModel parent) : base(uiComponents, parent)
        {
            Title = "Text Viewer";
            Session = session;
            TabClosed += (s,e) => parent.CloseSession(session);
            /*
        ...
        public TextualMediaSession Session { get; private set; }
        /*
