...
{
    class SlowSingleIncorrectTryLongCheck : LearningTactic
    {
        internal override LearningTactic? Prerequisite => new SlowSingleIncorrectTry();

        internal SlowSingleIncorrectTryLongCheck()
        {
